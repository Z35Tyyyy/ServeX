...
export default function Cart() {
    ...
    return (
        <div style={{ minHeight: '100vh', paddingBottom: 100, background: 'var(--color-bg-primary)' }}>
            <header style={{ display: 'flex', alignItems: 'center', gap: 16, padding: '20px 16px', background: 'rgba(255, 255, 255, 0.95)', backdropFilter: 'var(--glass-blur)', borderBottom: '1px solid var(--color-border)', position: 'sticky', top: 0, zIndex: 100 }}>
            ...
            <div style={{ padding: 16 }}>
                ...
                {items.map((item, idx) => (
                    <div key={item.menuItemId} className="card animate-slideUp" style={{ display: 'flex', gap: 16, padding: 16, marginBottom: 12, animationDelay: `${idx * 50}ms`, background: 'white' }}>
                ...
                <div className="card" style={{ padding: 24, marginTop: 24, background: 'white' }}>
