...
import { Utensils, UtensilsCrossed, LayoutGrid, ClipboardList, BarChart3, LogOut, ChefHat, Menu as MenuIcon, X } from 'lucide-react';
    ...
    return (
        <div className="admin-container">
            ...
            <aside className={`admin-sidebar ${isMobileOpen ? 'open' : ''}`}>
                <div style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '24px 32px', color: 'var(--color-primary-light)', fontSize: 20, fontWeight: 700, borderBottom: '1px solid var(--color-border)' }}>
                    <Utensils size={24} />
                    <span>ServeX</span>
                </div>
